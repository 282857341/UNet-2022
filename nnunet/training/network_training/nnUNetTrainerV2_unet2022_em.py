...
class nnUNetTrainerV2_unet2022_em(nnUNetTrainer):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        yamlData = loadData(data="/home/xychen/jsguo/yaml/EM_512.yaml")
        ...
        print('patch_size:{}'.format(self.patch_size))
    ...
    def do_split(self):
        ...
        #print(self.val_list)
        tr_keys = [i for i in self.dataset if i in self.train_list]    
        val_keys = [i for i in self.dataset if i in self.val_list]    
