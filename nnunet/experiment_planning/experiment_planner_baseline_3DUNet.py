...
class ExperimentPlanner(object):
    ...
    def plan_experiment(self):
        ...
        #with open('/home/xychen/new_transformer/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task010_a/te.txt','a') as f:
        #    f.write("the max shape in the dataset is \n", max_shape)
        #    f.write("the min shape in the dataset is ", min_shape)
